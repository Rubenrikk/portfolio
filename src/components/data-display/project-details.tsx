      ...
      >
        <Link noCustomization href={url} externalLink>
          <Image
            ...
            alt={`${name} preview`}
            className="block rounded-xl shadow-lg transition-transform duration-500 md:hidden md:hover:scale-105"
            style={{ objectFit: 'cover' }}
          />
          <Image
            src={previewImage}
            alt={`${name} preview`}
            className="hidden rounded-xl shadow-lg transition-transform duration-500 md:block md:hover:scale-105"
            style={{ objectFit: 'cover' }}
          />
        </Link>
      </div>
